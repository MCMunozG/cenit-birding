...
/**
 * Verifies an Accounts-issued JWT before an owner or moderator projection is selected.
 * The actor is intentionally a small claim set, not a replicated Accounts profile.
 */
